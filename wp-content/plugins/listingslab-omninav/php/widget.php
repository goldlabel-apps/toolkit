...
class omninav_Widget extends WP_Widget {
 
    function __construct() {
        parent::__construct( false, __( 'ToolKit Omninav', 'listingslab' ) );
    }
...
add_action( 'widgets_init', 'omninav_register_widget' ); 

function omninav_register_widget() {
    register_widget( 'omninav_Widget' );
}
