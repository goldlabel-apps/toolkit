...
class ironavirus_Widget extends WP_Widget {
 
    function __construct() {
        parent::__construct( false, __( '@Ionavirus', 'listingslab' ) );
    }
...
add_action( 'widgets_init', 'ironavirus_register_widget' ); 

function ironavirus_register_widget() {
    register_widget( 'ironavirus_Widget' );
}
